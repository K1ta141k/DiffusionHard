...
module mlp_residual_up_to_down_pipeline #(
    ...
    input  wire [GROUP_WIDTH-1:0] frontend_group,
    ...
    wire [UP_K_TILE_WIDTH-1:0] activation_load_k_tile;
    ...
    layer_norm_mlp_up_activation_frontend #(
        ...
        .residual_input_valid(residual_input_valid),
