...
set project_dir [file join $script_dir build output_head_hls]
...
set_top output_head_int8_kernel
add_files [file join $script_dir output_head.cpp]
add_files [file join $script_dir output_head.hpp]
add_files -tb [file join $script_dir output_head_test.cpp]
